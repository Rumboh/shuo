...
export const footerBannerData = {
  ...
  description:
    'View all brands of our collection on ButikSevdik, there is another collection. Please check it out bro, like seriously',
};

export const footerData = {
  description:
    'Butik Sevdik was designed and founded in 2015 by Hatice & Mehmet. The shop is about presenting customised home textile products with an elegant presentation for customers around the world.',
  footerLinks: [
    {
      title: 'Main Pages',
      links: [
...
export const newsletter = {
  ...
  description:
    'Drop your email below and start receiving the best offers from Butik Sevdik',
};
  ...
  directContactInfo: [
    {
      ...
      contactLink: {
        href: 'mailto:sales@butiksevdik.com',
        title: 'sales@butiksevdik.com',
      },
    },
    {
      ...
      description:
        'Lorem ipsum dolor sit amet consectetur adipiscing elit blandit velit semper aliquam.',
      contactLink: {
        href: 'mailto:support@butiksevdik.com',
        title: 'support@butiksevdik.com',
      },
    },
    {
      ...
      description:
        'Lorem ipsum dolor sit amet consectetur adipiscing elit blandit velit semper aliquam.',
      contactLink: {
        href: 'mailto:influencers@butiksevdik.com',
        title: 'influencers@butiksevdik.com',
      },
    },
  ],
  instagramPhotos: [
